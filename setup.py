...
MAIN_MODULE_NAME = "multikari"
TARGET_PROJECT_NAME = "multikari"
...
setuptools.setup(
    ...
    description="A process based Hikari shard cluster manager.",
    ...
    # TODO: entry point in a similar style to uvicorn
